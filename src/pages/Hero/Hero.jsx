...
const Hero = () => {
  ...
  return (
    <section
      ...
      className="relative min-h-screen overflow-hidden bg-[var(--bg-primary)] px-6 pt-28 text-white md:px-12 lg:px-20"
    >
      {/* Mouse glow */}
      <div
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-2">
        ...
        <div>
          ...
          <motion.h1
            ...
            className="max-w-3xl font-heading text-5xl font-extrabold leading-tight tracking-wider md:text-6xl lg:text-6xl"
          >
            I build clean, <br />
            responsive &{" "}
